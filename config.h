...
#define MOTION_THRESHOLD_DEFAULT_VALUE 0.0007
#define OPT_OUT_BUTTON_TIMEOUT_IN_MINUTES_DEFAULT_VALUE 120
#define INACTIVITY_TIMEOUT_IN_MINUTES_DEFAULT_VALUE 15
#define SAMPLE_SPEED_IN_MILLISECONDS_DEFAULT_VALUE 10

#define MINIMUM_MOTION_DETECTION_COUNT_REQUIRED_DEFAULT_VALUE 4

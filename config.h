...
#define IS_VARIANCE_CALCULATION_ENABLED 0
#define VARIANCE_CALCULATION_SAMPLE_SIZE 50 
#define VARIANCE_RECALIBARTION_THRESHOLD 0.05
#define VARIANCE_CALCULATION_INTERVAL_IN_SECONDS 60
